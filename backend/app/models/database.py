...
def save_detection(person: str, confidence: float, face_image: np.ndarray = None, 
                   camera_id: int = None, frames_to_save: list = None):
    ...
    try:
        ...
        if frames_to_save and len(frames_to_save) > 0:
...
# #     created_at = Column(DateTime, server_default=func.now())
# #     images = relationship("PersonnelImage", back_populates="personnel")
